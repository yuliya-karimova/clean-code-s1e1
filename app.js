...
var taskInput=document.querySelector(".task-item_new__input");//Add a new task.
var addButton=document.querySelector(".button-add");//add button
var incompleteTaskHolder=document.querySelector(".task-list_incomplete");// incomplete tasks list
var completedTasksHolder=document.querySelector(".task-list_completed");// completed tasks list
